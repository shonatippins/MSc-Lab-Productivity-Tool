...
<div class="hero">
    ...
    <p>AI-supported workflow decision support for Life Sciences SMEs.</p>
</div>
...
with st.sidebar:
    ...
    st.markdown("---")
    st.caption(
        "Decision-support prototype. Outputs are intended to support "
        "professional judgement rather than replace laboratory decisions."
    )
...
if page == "01 Diagnose":
    ...
    st.markdown('<span class="stage-chip">STAGE 01 · DIAGNOSE</span>', unsafe_allow_html=True)
...
if page == "02 Recommend":

    st.markdown('<span class="stage-chip">STAGE 02 · RECOMMEND</span>', unsafe_allow_html=True)
    ...
    if (
        ...
        with st.container(border=True):
            ...
            st.markdown("#### Approaches to Consider")
            ...
            st.caption(
                "The hosted Llama model considers the diagnostic results and "
                "available intervention approaches before recommending which "
                "option should be investigated first."
            )
...
if page == "03 Predict":
    ...
    st.markdown('<span class="stage-chip">STAGE 03 · PREDICT</span>', unsafe_allow_html=True)
...
if page == "04 Optimise":
    ...
    st.markdown('<span class="stage-chip">STAGE 04 · OPTIMISE</span>', unsafe_allow_html=True)
    ...
    if "predictive_model" not in st.session_state:
        ...
        if target != "Turnaround_Time_Hours":
            ...
            st.subheader("Baseline Workflow Scenario")
            ...
            if st.button(
                ...
                if len(scenarios) > 0:
                    ...
                    st.subheader("Predicted Productivity Outcome")
...
if page == "05 Evaluate":
    ...
    st.markdown('<span class="stage-chip">STAGE 05 · EVALUATE</span>', unsafe_allow_html=True)
    ...
    if st.session_state.productivity_outcome is None:
        ...
        st.subheader("Modelled Intervention Outcome")
        ...
        st.subheader("Observed Post-Intervention Performance")
