...
st.title("Laboratory Productivity Diagnostic Tool")

st.write(
    "This tool analyses laboratory productivity performance, identifies "
    "areas of underperformance, supports AI-based intervention selection, "
    "and provides a foundation for predictive workflow optimisation."
)
...
with tab1:
    ...
    if st.session_state.results_df is not None:
        ...
        st.subheader("Productivity Performance Gaps")
...
with tab2:
    ...
    if (
        ...
        st.subheader("Current Priority Problem")
        ...
        st.subheader("Potential Improvement Approaches")
...
with tab3:
    ...
    if uploaded_file is not None:
        ...
        try:
            ...
            st.subheader("Machine Learning Data Selection")
    ...
    st.subheader("Predict New Workflow Scenario")
...
with tab5:
    ...
    if st.session_state.productivity_outcome is None:
        ...
        if st.button(
            ...
            st.subheader("Productivity Evaluation Results")
